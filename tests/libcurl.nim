...
proc strequal*(s1, s2: cstring): int32{.cdecl,
                                        importc: "curl_strequal".}
proc strnequal*(s1, s2: cstring, n: int): int32{.cdecl,
...
proc formget*(form: Phttppost, arg: pointer, append: Formget_callback): int32{.
    cdecl, importc: "curl_formget".}
proc formfree*(form: Phttppost){.cdecl,
                                 importc: "curl_formfree".}
proc getenv*(variable: cstring): cstring{.cdecl,
    importc: "curl_getenv".}
proc version*(): cstring{.cdecl, importc: "curl_version".}
proc easy_escape*(handle: PCurl, str: cstring, len: int32): cstring{.cdecl,
    dynlib: libname, importc: "curl_easy_escape".}
proc escape*(str: cstring, len: int32): cstring{.cdecl,
    importc: "curl_escape".}
proc easy_unescape*(handle: PCurl, str: cstring, len: int32, outlength: var int32): cstring{.
    cdecl, importc: "curl_easy_unescape".}
proc unescape*(str: cstring, len: int32): cstring{.cdecl,
    importc: "curl_unescape".}
proc free*(p: pointer){.cdecl, importc: "curl_free".}
proc global_init*(flags: int32): Code{.cdecl,
...
proc global_init_mem*(flags: int32, m: Malloc_callback, f: Free_callback,
                      ...
                      c: Calloc_callback): Code{.cdecl,
    importc: "curl_global_init_mem".}
proc global_cleanup*(){.cdecl, importc: "curl_global_cleanup".}
proc slist_append*(slist: Pslist, p: cstring): Pslist{.cdecl,
    importc: "curl_slist_append".}
proc slist_free_all*(para1: Pslist){.cdecl,
                                     importc: "curl_slist_free_all".}
proc getdate*(p: cstring, unused: ptr Time): Time{.cdecl,
    importc: "curl_getdate".}
proc share_init*(): PSH{.cdecl, importc: "curl_share_init".}
proc share_setopt*(para1: PSH, option: SHoption): SHcode{.cdecl, varargs,
    dynlib: libname, importc: "curl_share_setopt".}
proc share_cleanup*(para1: PSH): SHcode{.cdecl,
    importc: "curl_share_cleanup".}
proc version_info*(para1: Version): Pversion_info_data{.cdecl,
    importc: "curl_version_info".}
proc easy_strerror*(para1: Code): cstring{.cdecl,
    importc: "curl_easy_strerror".}
proc share_strerror*(para1: SHcode): cstring{.cdecl,
    importc: "curl_share_strerror".}
proc easy_init*(): PCurl{.cdecl, importc: "curl_easy_init".}
proc easy_setopt*(curl: PCurl, option: Option): Code{.cdecl, varargs,
    importc: "curl_easy_setopt".}
proc easy_perform*(curl: PCurl): Code{.cdecl,
                                importc: "curl_easy_perform".}
proc easy_cleanup*(curl: PCurl){.cdecl, importc: "curl_easy_cleanup".}
proc easy_getinfo*(curl: PCurl, info: INFO): Code{.cdecl, varargs,
    importc: "curl_easy_getinfo".}
proc easy_duphandle*(curl: PCurl): PCurl{.cdecl,
                              importc: "curl_easy_duphandle".}
proc easy_reset*(curl: PCurl){.cdecl, importc: "curl_easy_reset".}
proc multi_init*(): PM{.cdecl, importc: "curl_multi_init".}
...
proc multi_perform*(multi_handle: PM, running_handles: var int32): Mcode{.
    cdecl, importc: "curl_multi_perform".}
proc multi_cleanup*(multi_handle: PM): Mcode{.cdecl,
...
proc multi_assign*(multi_handle: PM, sockfd: Socket, sockp: pointer): Mcode{.
    cdecl, importc: "curl_multi_assign".}
